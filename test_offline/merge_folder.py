...
def read_xml_label(path):
    ...
    for obj in objects:
        ...
        if name == 'knife' or name == 'scissors':
            label[-1] = 1.0
        elif name in object_categories:
...
class MyDatasetFolder(data.Dataset):
    ...
    def __init__(self, root, loader, extensions, transform=None, target_transform=None):
        ...
        print('merge_knife_xray_num:', merge_knife_xray_num)
