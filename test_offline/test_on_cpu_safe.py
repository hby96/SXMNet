...
from folder import MyFolderWoLabel
...
test_set_path = '../data_set/add_safe_imgs/test'

result_save_path = '/home/hubenyi/Multi-Label-Series/Xray-Multi-Label/test_offline/safe_result.json'
...
def prepare_data(test_set_path):
    ...
    test_folder = MyFolderWoLabel(test_set_path, transform=test_transform)
...
def eval_model(test_loader, model):
    ...
    with torch.no_grad():
        for batch_idx, (data, path) in tqdm(enumerate(test_loader), desc='Testing'):
            ...
            for i in range(data.shape[0]):
                ...
                info_dict['label'] = [0.1] * len(object_categories)
