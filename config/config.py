...
def create_parser():
    ...
    # Dataset Location
    # parser.add_argument('--train_set_path', default='../data_set/final_divide/data_train_test_split/train', type=str,
    ...
    parser.add_argument('--train_set_path', default='../data_set/03_20_train_test_split/balance_test', type=str,
                        help='root path of the train set')
    parser.add_argument('--test_set_path', default='../data_set/03_20_train_test_split/balance_test', type=str,
                        help='root path of the test path')
    ...
    parser.add_argument('--learning_rate', '-lr', type=float, default=1e-2, help='The Learning Rate.')# resnet: 1e-3 #双池化输出: 5e-3 gap: 5e-3 gmp:1e-3 gap gmp concat:1e-3 best_employ:1e-2
